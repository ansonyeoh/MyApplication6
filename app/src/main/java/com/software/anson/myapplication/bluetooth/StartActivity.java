...
//			    }
				...
				Log.i(TAG, "ACTION_NAME_RSSI rssi = " + rssi);

				start_text_system_Info = (TextView) findViewById(R.id.start_text_system_Info);

				start_text_system_Info.setText("RSSI: " + rssi + " dbm");
			}
		}
