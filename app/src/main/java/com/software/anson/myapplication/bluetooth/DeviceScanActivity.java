...
package com.software.anson.myapplication.bluetooth;
...
import com.software.anson.myapplication.bluetooth.BluetoothLeClass.OnDataAvailableListener;
import com.software.anson.myapplication.bluetooth.BluetoothLeClass.OnServiceDiscoverListener;
import com.software.anson.myapplication.bluetooth.iBeaconClass.iBeacon;
...
public class DeviceScanActivity extends ListActivity {
	...
	// writeValue[0]);
	// gattCharacteristic_char1.setValue(writeValue);
	...
	// if(gattCharacteristic_char5 != null){
	// //writeValue[0] = writeValue_char1++;
	// //Log.i(TAG, "gattCharacteristic_char6.setValue writeValue[0] =" +
	// writeValue[0]);
	// boolean bRet = gattCharacteristic_char5.setValue(string);
	// mBLE.writeCharacteristic(gattCharacteristic_char5);
	// }
	// }
	//
	//
